...
The web console: the run list, the workflow and its graph, the run inspector, the sharing panel and a format-preserving YAML editor. The roadmap says which release fills this repository: <https://agentiik.github.io/docs/roadmap>.
